...
public class UpdateAppointmentController implements Initializable {
     ...
     public void handleButtonAction(ActionEvent ev) throws IOException
    {
        //button/radio button actions
           ...
           if(ev.getSource() == reset_Btn){
               setApp(app.getAppointment_ID(), app.getAppsForView());
           }
           ...
           if(ev.getSource() == update_Btn){
               ...
               app.setAppointment_ID(Integer.parseInt(appointment_ID_TB.getText()));
               ...
               app.setLast_update(app.convertToUTC(app.currentTime));
    ...
    public void setApp(int appID, ObservableList<Appointments> appList){
        app.setAppointmentsList(appList);
        app.selectDB(appID);
        appointment_ID_TB.setText((Integer.toString(app.getAppointment_ID())));
        location_TB.setText(app.getLocation());
        title_TB.setText(app.getTitle());
        desc_TB.setText(app.getDescription());
        datePicker.setValue(app.getStart().toLocalDate());
        type_TB.setText(app.getType());
        user_ID_TB.setText((Integer.toString(app.getUser_ID())));
        cust_ID_TB.setText((Integer.toString(app.getCustomer_ID())));
       
        

      //listing of times
      //lambda used to efficiently set predicates for the filtered time list    
       ...
       start_Combo.getSelectionModel().select(app.getStart().toLocalTime());
       ...
       end_Combo.getSelectionModel().select(app.getEnd().toLocalTime());
